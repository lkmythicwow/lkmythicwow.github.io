...
<html>
<head>
	<title>Mythic WoW - CRIAR CONTA</title>
...
<div class="row">
	<div class="content">
		<div class="content-logo">
			MYTHIC<span class="orange">WOW</span>
		</div>

		<div class="content-box">
			<div class="content-box-content">
				<form method="POST">
					<label class="orange">Usuário</label>
					<input type="text" name="username" />

					<label class="orange">E-mail</label>
					<input type="text" name="email" />

					<label class="orange">Senha</label>
					<input type="password" name="password" />

					<label class="orange">Confirmar Senha</label>
					<input type="password" name="re-password" />

					<center>
						<div class="g-recaptcha" data-sitekey="<?php echo CAPTCHA_CLIENT_ID; ?>"></div>
						<br>
						<input type="submit" name="register" class="small button" value="Criar Conta" />
					</center>
				</form>
			</div>
		</div>
